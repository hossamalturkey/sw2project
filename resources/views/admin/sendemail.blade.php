            ...
            <div class="row" id="main">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="{!! url('admin/customers') !!}" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div id="response"></div>
                        <form method="POST" action="{!! action('CustomerController@sendemail') !!}" class="form-horizontal form-label-left">
                            {{csrf_field()}}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="name" value="{{$customer->name}}" disabled type="text">
                                </div>
                            </div>
                            <div class="item form-group">
